...
class EditorLanguage implements LanguageBlock {
    ...
    public static final LanguageString LOADING_GAME_EDITOR = new LanguageString("&e正在加载游戏编辑器");
    public static final LanguageString EDITOR_LOAD_FINISHED = new LanguageString("&a编辑器加载完成");
    public static final LanguageString EDITOR_LOAD_ERROR = new LanguageString("&c编辑器加载错误");
    ...
    public static final LanguageString UNMAKING_CHANGE = new LanguageString("&e正在移除 %s 个修改");
    public static final LanguageString UNMAKING_CHANGE_FINISHED = new LanguageString("&a修改移除完成");
    public static final LanguageString UNMAKING_CHANGE_ERROR = new LanguageString("&c移除修改失败");
    ...
    public static final LanguageString NOT_FOUND_CHANGE = new LanguageString("&c找不到 id 为 &e&l%s &r&c的修改");
    public static final LanguageString NOT_FOUND_COMMIT = new LanguageString("&c找不到指定的提交");

    public static final LanguageString AREA_PROPERTY_CHANGE = new LanguageString("区域属性修改");
    public static final LanguageString AREA_PROPERTY_CHANGE_NAME = new LanguageString("将 %s 从 %s 修改为 %s");

    public static final LanguageString GAME_PROPERTY_CHANGE = new LanguageString("游戏属性修改");
    public static final LanguageString GAME_PROPERTY_CHANGE_NAME = new LanguageString("将 %s 从 %s 修改为 %s");
}
